...
client.on("message", message => {
  ...
  try {
    ...
    arquivoComando.run(client, message, args, ops, database, firebase);
  } catch (erro) {
    console.log(erro)
    message.channel.send("**ERRO!**, o comando não foi encontrado, ou não esta funcionando, verifique sua ortografia e tente novamente, ou use **c!help** para obter a lista de comandos.");
    }
});
